...
Part 2: now do the same but predicteding the PREVIOUS history value
'''
...
PART 2: the difference is that rather than summing you take the first value and minus all the first differences
Very little code should change
'''
